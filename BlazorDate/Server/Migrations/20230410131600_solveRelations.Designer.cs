...
namespace BlazorDate.Server.Migrations
{
    ...
    [Migration("20230410131600_solveRelations")]
    partial class solveRelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorDate.Shared.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 10, 15, 16, 0, 171, DateTimeKind.Local).AddTicks(3296)
                        },
                        new
                        {
                            PersonId = 2,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 10, 15, 16, 0, 171, DateTimeKind.Local).AddTicks(3370)
                        },
                        new
                        {
                            PersonId = 3,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 10, 15, 16, 0, 171, DateTimeKind.Local).AddTicks(3373)
                        },
                        new
                        {
                            PersonId = 4,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 10, 15, 16, 0, 171, DateTimeKind.Local).AddTicks(3376)
                        });
                });
