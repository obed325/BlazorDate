...
namespace BlazorDate.Server.Migrations
{
    ...
    [Migration("20230327205946_picturedata")]
            ...
            modelBuilder.Entity("BlazorDate.Shared.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProfileText = "",
                            Stats = 0,
                            Updated = new DateTime(2023, 3, 27, 22, 59, 45, 966, DateTimeKind.Local).AddTicks(3162)
                        },
                        new
                        {
                            PersonId = 2,
                            ...
                            ProfileText = "",
                            Stats = 0,
                            Updated = new DateTime(2023, 3, 27, 22, 59, 45, 966, DateTimeKind.Local).AddTicks(3222)
                        },
                        new
                        {
                            PersonId = 3,
                            ...
                            ProfileText = "",
                            Stats = 0,
                            Updated = new DateTime(2023, 3, 27, 22, 59, 45, 966, DateTimeKind.Local).AddTicks(3224)
                        },
                        new
                        {
                            PersonId = 4,
                            ...
                            ProfileText = "",
                            Stats = 0,
                            Updated = new DateTime(2023, 3, 27, 22, 59, 45, 966, DateTimeKind.Local).AddTicks(3226)
                        });
                });
