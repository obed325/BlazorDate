...
namespace BlazorDate.Server.Migrations
{
    ...
    [Migration("20230412212639_PreferenceCategory")]
    partial class PreferenceCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlazorDate.Shared.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 12, 23, 26, 38, 727, DateTimeKind.Local).AddTicks(5127)
                        },
                        new
                        {
                            PersonId = 2,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 12, 23, 26, 38, 727, DateTimeKind.Local).AddTicks(5187)
                        },
                        new
                        {
                            PersonId = 3,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 12, 23, 26, 38, 727, DateTimeKind.Local).AddTicks(5190)
                        },
                        new
                        {
                            PersonId = 4,
                            ...
                            Stats = 0,
                            Updated = new DateTime(2023, 4, 12, 23, 26, 38, 727, DateTimeKind.Local).AddTicks(5193)
                        });
                });
